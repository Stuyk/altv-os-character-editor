                                ...
                                parse: function(g, h, j) {
                                    ...
                                    try {
                                        q.start(g, a.chunkInput, function(a, e) {
                                            throw new d(
                                                { index: e, type: 'Parse', message: a, filename: c.filename },
                                                b
                                            );
                                        }),
                                ...
                                parsers: (p = {
                                    ...
                                    entities: {
                                        ...
                                        customFuncCall: function(a) {
                                            ...
                                            return { alpha: b(p.ieAlpha, !0), boolean: b(c), if: b(c) }[
                                                a.toLowerCase()
                                            ];
                                        },
                                        arguments: function(a) {
                                            ...
                                            for (q.save(); ; ) {
                                                if (a) a = !1;
                                                    ...
                                                    if (
                                                        ((c =
                                                            p.detachedRuleset() || this.assignment() || p.expression()),
                                                        !c)
                                                    )
                                                        break;
                                    ...
                                    mixin: {
                                            ...
                                            for (q.save(); ; ) {
                                                ...
                                                if (
                                                    ...
                                                    if (q.$char(':')) {
                                                        if (
                                                            (m.length > 0 &&
                                                                (b && j('Cannot mix ; and , as delimiter types'),
                                                                (c = !0)),
                                        ...
                                        ruleLookups: function() {
                                            ...
                                            if ('[' === q.currentChar()) {
                                                for (;;) {
                                                    if (
                                                        (q.save(), (b = null), (a = this.lookupValue()), !a && '' !== a)
                                                    ) {
                                                        q.restore();
                                                        break;
                                                    }
                                                    ...
                                                    : q.$char('(') &&
                                                      ...
                                                      q.$char(')')
                                                          ? b && a
                                                              ? f.push(
                                                                    new e.Paren(
                                                                        new e.Declaration(b, a, null, null, q.i, c, !0)
                                                                    )
                                                                )
                                                              : a
                                    ...
                                    multiplication: function() {
                                        ...
                                        if ((a = this.operand())) {
                                            for (f = q.isWhitespace(-1); ; ) {
                                                if (q.peek(/^\/[*\/]/)) break;
                                                if (
                                                    (q.save(), (c = q.$char('/') || q.$char('*') || q.$str('./')), !c)
                                                ) {
                                                    q.forget();
                                                    break;
                                                }
                ...
                function(a, b, c) {
                    ...
                    (e.prototype = new d()),
                        ...
                        (e.prototype.toCSS = function(a) {
                            ...
                            return (
                                this.op && ((b += this.op), (b += this.value.toCSS ? this.value.toCSS(a) : this.value)),
                                '[' + b + ']'
                            );
                        }),
                        (b.exports = e);
                    ...
                    (h.prototype = new d()),
                        ...
                        (h.prototype.eval = function(a) {
                            ...
                            for (this.selector = this.selector.eval(a), j = 0; j < this.arguments.length; j++)
                                if (
                                    ((h = this.arguments[j]), (i = h.value.eval(a)), h.expand && Array.isArray(i.value))
                                )
                            ...
                            if (
                                (b.importMultiple ||
                                    (a.skip =
                                        ...
                                        function() {
                                            return (
                                                f in g.onceFileDetectionMap || ((g.onceFileDetectionMap[f] = !0), !1)
                                            );
                                        }),
                                !f && j && (a.skip = !0),
